...
cat <<EOF
           ___              __    _
 _      __/   |  __________/ /_  (_)   _____  _____
| | /| / / /| | / ___/ ___/ __ \/ / | / / _ \/ ___/ $AUTHOR
| |/ |/ / ___ |/ /  / /__/ / / / /| |/ /  __/ /     $VERSION
|__/|__/_/  |_/_/   \___/_/ /_/_/ |___/\___/_/      $COMMENT
...
echo ""
echo -e "---------------------------------------------------------------"
echo -e "\e[2m$(ls $mp3 | grep $(cat /tmp/artist_names))\e[0m"
echo -e "--------------------------------------------------------------\n\nVERBOSE MODE IS \e[1;32mON\e[0m - (BE PREPARED FOR ALOT OF SPAM)\n"
echo ""

mkdir -p $mp3_archive/_$archive_dir/
cp -v -r $mp3/$(cat /tmp/artist_names)* $mp3_archive/_$archive_dir/
